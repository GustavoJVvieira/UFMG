...
int main() {
    ...
    *ptr = 5;
    ...
    // 24) Imprima os elementos de (3) a partir da variável do vetor utilizando a notação []
    for (int i = 0; i < size; i++) {
        cout << arr[i];
        if (i != size - 1) cout << " "; // Adiciona espaço entre elementos
    }
    cout << endl;
